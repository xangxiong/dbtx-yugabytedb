...
class YugabytedbIndexMethod(StrEnum):
    btree = "btree"
    hash = "hash"
    gist = "gist"
    spgist = "spgist"
    ...
    @classmethod
    def default(cls) -> "YugabytedbIndexMethod":
        return cls.btree


@dataclass(frozen=True, eq=True, unsafe_hash=True)
class YugabytedbIndexConfig(RelationConfigBase, RelationConfigValidationMixin):
    """
    ...
    method: YugabytedbIndexMethod = field(default=YugabytedbIndexMethod.default(), hash=True)
    ...
    @classmethod
    def from_dict(cls, config_dict) -> "YugabytedbIndexConfig":
        ...
        index: "YugabytedbIndexConfig" = super().from_dict(kwargs_dict)  # type: ignore
        return index
...
@dataclass(frozen=True, eq=True, unsafe_hash=True)
class YugabytedbIndexConfigChange(RelationConfigChange, RelationConfigValidationMixin):
    """
