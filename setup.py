...
package_name = "dbtx-yugabytedb"
# For test build we should suffix it with -#, like: 1.7.5-1.
# This will generate a build version as 1.7.5.post1.
# When updating the package_version here, you must update the version in dbt.adapters.yugabytedb.__version__ as well
package_version = "1.7.8"
description = """The yugabytedb adapter plugin for dbt (data build tool)"""
...
setup(
    ...
    url="https://github.com/xangxiong/dbtx-yugabytedb",
